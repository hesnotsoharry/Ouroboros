...
- Version bumped to **`v2.34.0`** (minor) — net effect is cross-project capability addition; breaking removal of the in-IDE graph subsystem is internal-only (no external API consumer exists for the IDE's main-process modules). (v2.29.0–v2.33.0 are already taken by Waves 8 through 6 between 2026-05-22 and 2026-05-24; this wave takes the next free slot.)
