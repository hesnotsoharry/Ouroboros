/**
 * AgentCompletionIndicators.helpers.ts — Wave 100
 *
 * Pure helpers extracted from useWorkbenchAttention.agentSource.ts when
 * the InnerSidebarChats subtree was removed. These helpers only involve
 * AgentSession / TerminalSession state, NOT chat threads.
 */
