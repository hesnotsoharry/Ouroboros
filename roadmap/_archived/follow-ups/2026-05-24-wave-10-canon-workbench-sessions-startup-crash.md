...
created: 2026-05-24
updated: 2026-05-24
resolved-during: wave-11-file-tree-viewer-modal
...
## Resolution (wave-11-file-tree-viewer-modal)

Closed by `haiku-followup-auditor` during wave audit on 2026-05-24.
Evidence: Explicit resolution marker in frontmatter (`resolved-in: wave-11-file-tree-viewer-modal`); commit `cacaef21` in wave-11-result.md commits table (configPreflight reset for legacy canonWorkbenchSessions shape); full root-cause analysis, fix details, and verification documented in this file's body.
